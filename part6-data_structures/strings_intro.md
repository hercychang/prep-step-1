...
<iframe frameborder="0" width="100%" height="500px" src="https://repl.it/@AppAcademy/GreenyellowCluelessSkimmer?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="500px" src="https://repl.it/@AppAcademy/OliveCadetbluePipit?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="500px" src="https://repl.it/@AppAcademy/PoliticalUntidyAngora?lite=true"></iframe>

It's also sometimes useful to multiply strings using the `*` operator, which
functions as you'd expect:

<iframe frameborder="0" width="100%" height="500px" src="https://repl.it/@AppAcademy/UniqueElegantAsianlion?lite=true"></iframe>
